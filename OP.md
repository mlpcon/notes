Votes are in and we have our dates!  Now it's time to submit those panelist and vendor apps.
Also, I need some help making a website this year.
If you want to lend a hoof, please reply here.
[spoiler]otherwise, I'll have to use AI[/spoiler]
...
>What now?
/mlp/ con is what (You) make of it.  We need volunteers!
...
- Volunteer to help with our technology stuff if you're a nerd
...
- Keep the planning thread bumped (if a thread dies, I'll try to start a new one on the following Saturday)
